...
public class UtilitiesGetLastPosTest {
    ...
    /**
     * Test of getLastPos method, of class ExerciseUtilities.
     */
@Test
    public void testGetLastPos() {
        ...
        int value = 10;
        int expResult = 9;
        int result = ExerciseUtilities.getLastPos(nums, value);
    ...
    @Test
    public void testGetLastNullArray() {
        System.out.println("Testing getLastPos where array supplied is null");
        int[] nums = null;
        int value = 10;
        
        assertThrows(NullPointerException.class, () -> {ExerciseUtilities.getLastPos(nums, value);}, "NullPointerException was expected");
    }
}
